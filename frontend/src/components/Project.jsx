const LAYERS = [
    ...
    },
    {
        ...
        items: [
            {
                name: "Groq + Llama 3.3",
                desc: "70B open-weight model via Groq inference",
            },
            {
                name: "Context Injection",
                desc: "Full resume data embedded in system prompt",
            },
            {
                name: "Few-Shot Prompting",
                desc: "34 curated Q&A pairs guide response style",
            },
            {
                name: "Prompt Engineering",
                desc: "Behavioral rules for scope, tone & voice",
            },
            {
                name: "SSE Streaming",
                desc: "Token-by-token response via Server-Sent Events",
            },
        ],
    },
    {
        ...
        items: [
            {
                name: "Docker",
                desc: "Multi-stage builds, Compose orchestration",
            },
        ...
        <section id="project" className="py-16 bg-gray-50 dark:bg-gray-800/50">
            <div className="max-w-5xl mx-auto px-4 sm:px-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-3xl">
                    This resume website is itself a full-stack project —
                    designed, built, and deployed by me to demonstrate practical
                    engineering skills beyond what a PDF can show.
                </p>
