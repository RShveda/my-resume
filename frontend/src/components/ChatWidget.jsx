...
export default function ChatWidget() {
  ...
  if (!isOpen) {
    return (
      <div className="fixed right-4 sm:right-6 z-50 flex items-center gap-3" style={{ bottom: "calc(1.5rem + env(safe-area-inset-bottom, 0px))" }}>
        {/* Floating label */}
        {showLabel && (
          <div
      ...
      <div className="px-4 py-3 border-t border-gray-200 dark:border-gray-700">
        <div className="flex gap-2">
          <input
            ...
            maxLength={500}
            className="flex-1 min-w-0 px-3 py-2 text-base sm:text-sm bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg border-0 outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 dark:placeholder-gray-500"
          />
          <button
            onClick={sendMessage}
